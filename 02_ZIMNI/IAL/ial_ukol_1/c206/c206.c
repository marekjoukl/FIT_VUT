...
void DLL_DeleteFirst( DLList *list ) {
	DLLElementPtr newElem;
	if (list->firstElement != NULL)
	{
		newElem = list->firstElement;
...
void DLL_DeleteAfter( DLList *list ) {
	if (list->activeElement != NULL)
	{
		...
		{
			DLLElementPtr newElem = list->activeElement->nextElement;
			list->activeElement->nextElement = newElem->nextElement;
			if(newElem == list->lastElement){
				list->lastElement = list->activeElement;
			} else {
				newElem->nextElement->previousElement = list->activeElement;
			}
			free(newElem);
		}
	}
...
void DLL_DeleteBefore( DLList *list ) {
	if (list->activeElement != NULL)
	{
		...
		{
			DLLElementPtr newElem = list->activeElement->previousElement;
			list->activeElement->previousElement = newElem->previousElement;
			if(newElem == list->firstElement){
				list->firstElement = list->activeElement;
			} else {
				newElem->previousElement->nextElement = list->activeElement;
			}
			free(newElem);
		}
	}
