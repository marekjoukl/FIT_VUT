Feature: Admin Management of Goods and Stock
    ...
    Scenario: Inspect the list of products (12)
        Given User is on the admin Homepage
    ...
    Scenario: Add new product (13)
        Given User is on the Products page - Add new product
    ...
    Scenario: Update product details (14)
        Given There is an existing product in the system - Update product
        And User is on the Products page - Update product
    ...
    Scenario: Delete product (16)
        Given User is on the Products page - Delete product
